...
static struct reg_value ov3640_setting_15fps_QXGA_2048_1536[] = {
	...
	/*{0x3012, 0x80, 0, 0},*/ {0x304d, 0x45, 0, 0}, {0x30a7, 0x5e, 0, 0},
	{0x3087, 0x16, 0, 0}, {0x309c, 0x1a, 0, 0}, {0x30a2, 0xe4, 0, 0},
	{0x30aa, 0x42, 0, 0}, {0x30b0, 0xfc, 0, 0}, {0x30b1, 0xff, 0, 0},
	{0x30b2, 0x10, 0, 0}, {0x300e, 0x32, 0, 0}, {0x300f, 0x21, 0, 0},
	{0x3010, 0x20, 0, 0}, {0x3011, 0x00, 0, 0}, {0x304c, 0x81, 0, 0},
	{0x30d7, 0x10, 0, 0}, {0x30d9, 0x0d, 0, 0}, {0x30db, 0x08, 0, 0},
	{0x3016, 0x82, 0, 0}, {0x3018, 0x38, 0, 0}, {0x3019, 0x30, 0, 0},
...
static struct reg_value ov3640_setting_15fps_XGA_1024_768[] = {
	...
	{0x30aa, 0x42, 0, 0}, {0x30b0, 0xff, 0, 0}, {0x30b1, 0xff, 0, 0},
	{0x30b2, 0x10, 0, 0}, {0x300e, 0x32, 0, 0}, {0x300f, 0x21, 0, 0},
	{0x3010, 0x20, 0, 0}, {0x3011, 0x01, 0, 0}, {0x304c, 0x81, 0, 0},
	{0x30d7, 0x10, 0, 0}, {0x30d9, 0x0d, 0, 0}, {0x30db, 0x08, 0, 0},
	{0x3016, 0x82, 0, 0}, {0x3018, 0x38, 0, 0}, {0x3019, 0x30, 0, 0},
	{0x301a, 0x61, 0, 0}, {0x307d, 0x00, 0, 0}, {0x3087, 0x02, 0, 0},
	{0x3082, 0x20, 0, 0}, {0x3015, 0x12, 0, 0}, {0x3014, 0x04, 0, 0},
	...
	{0x3020, 0x00, 0, 0}, {0x3021, 0x1d, 0, 0},
	{0x3022, 0x00, 0, 0}, {0x3023, 0x0a, 0, 0}, 
	{0x3024, 0x08, 0, 0}, {0x3025, 0x18, 0, 0}, 
	{0x3026, 0x06, 0, 0}, {0x3027, 0x0c, 0, 0},
	
	{0x335f, 0x68, 0, 0}, {0x3360, 0x18, 0, 0}, {0x3361, 0x0c, 0, 0},
	{0x3362, 0x68, 0, 0}, {0x3363, 0x08, 0, 0}, {0x3364, 0x04, 0, 0},
	{0x3403, 0x42, 0, 0},/* {0x3088, 0x08, 0, 0}, {0x3089, 0x00, 0, 0},
	{0x308a, 0x06, 0, 0}, {0x308b, 0x00, 0, 0}, */
	
	{0x3088, 0x08, 0, 0}, {0x3089, 0x00, 0, 0},
	{0x308a, 0x06, 0, 0}, {0x308b, 0x00, 0, 0},
	...
	/*{0x3080, 0x80, 0, 0}, {0x307b, 0x02, 0, 0}, {0x307d, 0x80, 0, 0},
	{0x306c, 0x00, 0, 0},*/
#else
{0x3012, 0x80, 0, 0}, {0x304d, 0x45, 0, 0}, {0x30a7, 0x5e, 0, 0},
	{0x3087, 0x16, 0, 0}, {0x309c, 0x1a, 0, 0}, {0x30a2, 0xe4, 0, 0},
...
static struct reg_value ov3640_setting_30fps_VGA_640_480[] = {
	...
	{0x302d, 0x00, 0, 0}, {0x307c, 0x03, 0, 0},
...
static struct ov3640_mode_info ov3640_mode_info_data[2][ov3640_mode_MAX + 1] = {
	...
	},
	{
		...
		{ov3640_mode_720P_1280_720,  1280, 720,NULL,0},
		{ov3640_mode_1080P_1920_1080,  1920, 1080,NULL,0},
		{ov3640_mode_XGA_1024_768,   1024, 768,
...
static const struct of_device_id ov3640_of_match[] = {
	{ .compatible = "ovti,ov3640" },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, ov3640_of_match);
...
static struct i2c_driver ov3640_i2c_driver = {
	.driver = {
		  .owner = THIS_MODULE,
		  .name  = "ov3640",
		  .of_match_table = of_match_ptr(ov3640_of_match),
		  },
	.probe  = ov3640_probe,
...
static inline void ov3640_power_down(int enable)
{
...
static inline void ov3640_reset(void)
{
	/* camera reset */
			    ...
			    enum ov3640_mode mode)
{
	...
	pr_debug("use frame_rate %d ,mode %d\n",frame_rate,mode);
...
static int ioctl_dev_init(struct v4l2_int_device *s)
{
	...
	clk_set_rate(ov3640_data.sensor_clk, ov3640_data.mclk);
...
int checkIfOV3640(struct v4l2_subdev *sd)
{
	unsigned int i,pid;
	unsigned char pid_h,pid_l;
	
	for(i=0;i<5;++i)
	{
		ov3640_read_reg(0x300a,&pid_h);
		ov3640_read_reg(0x300b,&pid_l);

		pid = (pid_h<<8)|pid_l;
		pr_debug("product ID 0x%04X, expect 0x%04X\n", pid, 0x364c);
		if(pid == 0x364c)
		{
			printk("ov3640 found!\n");
			return 0;				
...
static int ov3640_regulator_enable(struct device *dev)
{
	int ret = 0;
			...
			const struct i2c_device_id *id)
{
	...
	ov3640_data.sensor_clk = devm_clk_get(dev, "csi_mclk");
	if (IS_ERR(ov3640_data.sensor_clk)) {
		dev_err(dev, "get mclk failed\n");
		return PTR_ERR(ov3640_data.sensor_clk);
	}
	...
	clk_prepare_enable(ov3640_data.sensor_clk);
	
	ov3640_data.io_init = ov3640_reset;
	...
	ov3640_regulator_enable(&client->dev);
	...
	clk_disable_unprepare(ov3640_data.sensor_clk);
	dev_err(dev, "ov3640 exit\n");
...
module_i2c_driver(ov3640_i2c_driver);

...
@ -imultilib armv7-a
@ -iprefix /opt/EmbedSky/TQIMX6/android-6.0.1-2.1.0/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/../lib/gcc/arm-linux-androideabi/4.9.x-google/
@ -D __KERNEL__ -D __UBOOT__ -D CONFIG_SYS_TEXT_BASE=0x17800000 -D __ARM__
@ -D DO_DEPS_ONLY -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /opt/EmbedSky/TQIMX6/android-6.0.1-2.1.0/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/../lib/gcc/arm-linux-androideabi/4.9.x-google/include
@ -include ./include/linux/kconfig.h -MD lib/.asm-offsets.s.d
@ lib/asm-offsets.c -mbionic -marm -mno-thumb-interwork -mabi=aapcs-linux
@ -mword-relocations -mno-unaligned-access -mfloat-abi=soft -march=armv7-a
@ -mfpu=vfp -mtls-dialect=gnu -auxbase-strip lib/asm-offsets.s -g -Os -Wall
...
@ -fverbose-asm -fzero-initialized-in-bss -mandroid -marm -mbionic
...
.LASF56:
	...
	.ascii	"marm -mno-thumb-interwork -mabi=aapcs-linux -mword-"
	.ascii	"relocations -mno-unaligned-access -mfloat-abi=soft "
	.ascii	"-march=armv7-a -mfpu=vfp -mtls-dialect=gnu -g -Os -"
	.ascii	"fno-builtin -ffreestanding -fno-stack-protector -fs"
...
.LASF58:
	.ascii	"/opt/EmbedSky/TQIMX6/android-6.0.1-2.1.0/bootable/b"
	.ascii	"ootloader/uboot-imx\000"
.LASF13:
	.ascii	"ulong\000"
.LASF5:

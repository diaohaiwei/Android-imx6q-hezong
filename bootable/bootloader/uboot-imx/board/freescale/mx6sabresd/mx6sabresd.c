...
#endif /* CONFIG_MX6DL && CONFIG_MXC_EPDC */
...
static iomux_v3_cfg_t const ecspi2_pads[] = {
	...
	MX6_PAD_CSI0_DAT11__ECSPI2_SS0		| MUX_PAD_CTRL(NO_PAD_CTRL),
};
#else
...
#if 0//def CONFIG_EMBEDSKY_E9
	printf("%s fin to rework network!\n", __func__);
	phy_write(phydev, MDIO_DEVAD_NONE, 0x00, 0x3340);
	udelay(10000);
#else
